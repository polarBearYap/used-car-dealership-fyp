...
{
    public partial class CreateCarPriceAndLeadTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DontEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DontCall = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Occupation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReceivedFreeCopy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvgPageViewPerVisit = table.Column<double>(type: "float", nullable: false),
                    CreatedTimestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PredictedScore = table.Column<double>(type: "float", nullable: false),
                    TotalSiteVisit = table.Column<double>(type: "float", nullable: false),
                    TotalTimeSpendOnSite = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    PredictedPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ...
                    CreatedTimestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAnalytics = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
